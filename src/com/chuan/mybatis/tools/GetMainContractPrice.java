...
//					System.out.println(spotPrice.length());
					spotPrice = BigDecimal.valueOf(Double.valueOf(spotPrice).doubleValue()).multiply(BigDecimal.valueOf(80.0)).toString();
				}
				if (goods.equals("鸡蛋")) {
					spotPrice = BigDecimal.valueOf(Double.valueOf(spotPrice).doubleValue()).multiply(BigDecimal.valueOf(500.0)).toString();
				}
